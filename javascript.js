...
while (true) {
  let precioProducto = prompt("Ingrese el precio del producto (o ingrese 'total' para obtener el total de la compra):");
...
// NaN es la abreviatura de not-a-number.
  if (!isNaN(precio)) {
    ...
    console.log("Precio no válido. Por favor, ingrese un número válido o 'total' para obtener el total de la compra.");
  }
}
